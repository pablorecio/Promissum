...
public class Promise<Value, Error> {
  ...
  public convenience init(value: Value) {
    self.init(source: PromiseSource(state: .Resolved(value), dispatch: .Unspecified, originalSource: nil, warnUnresolvedDeinit: false))
  }
  ...
  public convenience init(error: Error) {
    self.init(source: PromiseSource(state: .Rejected(error), dispatch: .Unspecified, originalSource: nil, warnUnresolvedDeinit: false))
  }
